          ...
          <div className="flex items-start justify-between gap-2">
            <div className="min-w-0 flex-1">
              ...
              <div className="flex items-center gap-1.5 mt-1 flex-wrap">
                ...
                {item.size && <span className="text-[9px] bg-primary/10 text-primary px-1.5 py-0.5 rounded font-bold">{item.size}</span>}
                <span className="text-[10px] text-muted-foreground">{formatCurrency(item.price)} each</span>
              </div>
            </div>
            <button
          ...
          <div className="flex items-center justify-between mt-3">
            ...
            <div className="text-right">
              ...
              <p className={cn(
                ...
                item.stock < 10 ? 'text-destructive' : 'text-muted-foreground',
              )}>
                {item.stock} in stock
              </p>
            </div>
